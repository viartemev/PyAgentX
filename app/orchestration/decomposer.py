...
2.  **Code Review ОБЯЗАТЕЛЕН**: Сразу после каждого шага, в котором `CodingAgent` пишет или изменяет код, должен следовать шаг "Провести Code Review", назначенный на `ReviewerAgent`.
...
[
    ...
    },
    {
        ...
        "task": "Провести Code Review для функции 'multiply' в 'app/agents/tools.py'.",
        "description": "Проверить код новой функции 'multiply' на наличие ошибок, опечаток и соответствие требованиям. Если все хорошо, ответить 'LGTM'. Иначе - предложить исправления."
    },
    {
        "step": 3,
        "assignee": "CodingAgent",
