...
4.  **Сфокусированное тестирование**: Шаг для тестирования должен указывать конкретный файл с тестами. В `description` задачи ОБЯЗАТЕЛЬНО включи пример вызова инструмента, например: `Используя 'run_tests', вызови его так: run_tests_tool({'path': 'tests/test_tools.py'})`.
